...
enum {
	MAX_CHARS = 0x200, CHAR_WIDTH = 8, DISPLAY_CHARS = 6, MAX_WIDTH = MAX_CHARS * CHAR_WIDTH, HEIGHT = 11, MAX_MESSAGES = 8, MAX_BRIGHTNESS = 3
};
		...
		const wchar_t *serial)
{
	...
	self = calloc(1, sizeof(ledbadge_t));
	if(!self)
		goto error_0;
